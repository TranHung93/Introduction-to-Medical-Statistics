...
# Zoom link for online participants {.unnumbered}

- Zoom link [here](https://zoom.us/j/99703191986?pwd=tUBHoIHNtggLlbepFrjTYUxdHyeYVS.1)
- For **Meeting ID** and **passcode** please email [tuyenhn\@oucru.org](mailto:tuyenhn\@oucru.org)
...
- Exercises:
  - [Handout file]{style="cursor:not-allowed;user-select:none;"}
  - [Exercise answer key]{style="cursor:not-allowed;user-select:none;"}
  - [Exercise answer script]{style="cursor:not-allowed;user-select:none;"}
...
- [Exercises](handouts/exercises_Day3.qmd){style="cursor:not-allowed;user-select:none;"}
...
- [Exercises]{style="cursor:not-allowed;user-select:none;"}
- [Exercise answer keys]{style="cursor:not-allowed;user-select:none;"}
...
- [Exercises](handouts/exercises_Day5.qmd){style="cursor:not-allowed;user-select:none;"}
- [Exercise answer keys]{style="cursor:not-allowed;user-select:none;"}
