...
Exercise 3.b. There are high values for fare that disturb the plot. Therefore, only show the
...
- Check the mode of each of the variables in the `titanic` data set using `sapply`
  and `mode`
