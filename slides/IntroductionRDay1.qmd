...
## Data: columns and selections within a single column {.smaller .scrollable}
...
- Can make it into a <span style="color:red;">package</span>, i.e. a collection of
    functions (and data):
  - [survival](https://github.com/therneau/survival){target="_blank"}
...
- Objects created by others 
  ...
  - Many more on [GitHub](https://rdrr.io/find/?repos=cran%2Cbioc%2Crforge%2Cgithub&page=0&fuzzy_slug=){target="_blank"} and [Bioconductor](https://www.bioconductor.org/packages/release/BiocViews.html#___Software){preview-link="true"}
...
```{webr-r}
table(titanic$age==NA) # not correct
3==NA # NA value gives missing as output
is.na(3)
...
- `View`: opens a spreadsheet-style data viewer
   ...
   In RStudio: click on the name of an object in the **Environment** tab
...
## Make exercises 6, 7, 8, 9 and 10 {.scrollable}
...
- [Good explanation](https://www.gormanalysis.com/blog/r-introduction-to-factors-tutorial){preview-link="true"}
