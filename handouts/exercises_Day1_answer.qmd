...
abstract: You might have done exercises 1 and 2 directly on the material slide. For exercises 3 to 7, you will do them in RStudio. Please make sure that you have R and RStudio installed on your laptop.
execute:
  echo: true
  eval: true
---
...
of mode character. `age` is of mode character, while one would expect it to be of
mode numeric
